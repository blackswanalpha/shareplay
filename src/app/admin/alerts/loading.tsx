  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="adm-skel" style={{ width: 200, height: 26 }} />
        <div className="adm-skel" style={{ width: 130, height: 34, borderRadius: 6 }} />
      </div>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {[1, 2, 3].map((i) => (
          <div key={i} className="adm-skel" style={{ width: 100, height: 30, borderRadius: 6 }} />
        ))}
      </div>
      ...
      <div style={{ borderRadius: 12, border: "1px solid rgba(255,255,255,0.06)", overflow: "hidden" }}>
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            ...
            <div className="adm-skel" style={{ width: 160, height: 14 }} />
