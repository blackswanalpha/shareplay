  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        >
          {/* Tabs */}
          <div style={{ display: "flex", borderBottom: "1px solid rgba(255,255,255,0.1)", padding: "0 4px" }}>
            {[true, false, false].map((active, i) => (
              <div
                ...
                style={{
                  ...
                  borderBottom: active ? "2px solid rgba(255,66,66,0.3)" : "2px solid transparent",
                }}
              >
